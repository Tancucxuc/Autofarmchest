...
Notification.new("<Color=Yellow> Loading <Nameless Hub> <Color=/>"):Display()
Notification.new("<Color=Red> Made by tanyeuem<Color=/>"):Display()
Notification.new("<Color=White> CTV Namdz-Tanoccho hihi<Color=/>"):Display()
Notification.new("<Color=Blue> Discord:https://discord.com/invite/4wwH5k3h22 <Color=/>"):Display()
-------------------// I Write... \\----------------------------------------
...
local CoreGui = game:GetService("StarterGui")
CoreGui:SetCore("SendNotification", {
    Title = "Nameless auto chest",
    Text = "By tancucxuc",
    Icon = "rbxthumb://type=Asset&id=71643263677630&w=150&h=150",
    Duration = math.huge,
    Callback = AllowRunServiceBind,
    Button1 = "ON",
    Button2 = "OFF",
